...
export default function Footer() {
    return (
        <footer className="relative overflow-hidden border-t border-border/80 bg-background">
                ...
                <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
                    <div className="flex flex-col items-center gap-2 md:items-start">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Copyright {new Date().getFullYear()} All rights reserved. Built with precision and craft.
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-6">
                        <a
                            ...
                            className="rounded-2xl border bg-background p-3 text-muted-foreground shadow-sm transition-all hover:border-primary hover:text-primary hover:shadow-lg hover:shadow-primary/5"
                        >
                            <Github size={22} />
                        </a>
                        <a
            ...
            <div className="absolute bottom-0 right-0 -z-10 h-[20%] w-[20%] rounded-full bg-primary/5 blur-[80px]" />
        </footer>
    );
}
